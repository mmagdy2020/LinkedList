...
class ArrayList {
    ...
    contains(element) {
        //  The method should assume that the user has sorted the list before calling contains().

        if (this.length > this.capacity) {
            return 100
        }

        if (this.length <= this.capacity) { // if the length less than the Orignal capacity...
        ...
        //     let begin = 0;
        //     let end = newStorage.length;
        //     while (end - begin > 1) {
        //         let middle = Math.floor((begin + end) / 2);
        //         if (newStorage[middle] > element) {
        //             end = middle;
        //         } else {
        //             begin = middle;
        //         }
        //     }
        //     if (element === newStorage[begin]) {
        //         return begin;
        //     } else {
        //         return -1;
        //     }

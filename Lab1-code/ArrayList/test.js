...
describe("ArrayList", function() {
    ...
    describe("contain() method", function() {
        it("check the contain of the element...", function() {
            ...
            arrayList.sort((a, b) => { // sorting use the defined compatotor...
                if (a < b) {
                    return -1;
                }
                if (b > a) {
            ...
            assert.equal(arrayList.get(1), "enormous"); // enormous, sorting is working perfectly...


            assert.equal(arrayList.contains("enormous"), 0);
            // assert.equal(arrayList.get(1), 3);
        });
    });
